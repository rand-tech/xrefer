*NOTE: This guide is a work in progress. It does not exhaustively go over all available functionalities and use cases of XRefer. However, this is a good place to start and will continue to be updated.*
